# Container for Postgresql backup/restore database & copy to S3!

![](pgsql-backup-docker.png)

---
 
 **A simple docker image with postgresql and awscli for backup/restore postgresql database to s3**
